<template>
    <div>
        <base-header style="background-color:#DB8D07" class="pb-6 pb-8 pt-5 pt-md-8">
            <!-- Card stats -->
        ...
        <card shadow type="secondary">
          ...
          <template>
            <form @submit.prevent>
              ...
              <hr class="my-4" />
              <!-- Address -->
              <h6 class="heading-small text-muted mb-4">Imagem Principal da notícia</h6>
              <div class="pl-lg-4">
                <div class="row">
                  <div class="col-md-12">
                    <input type="file">
              ...
              <hr class="my-4" />
              <!-- Address -->
              <h6 class="heading-small text-muted mb-4">Outras fotos sobre a notícia</h6>
              <div class="pl-lg-4">
                <div class="row">
                  <div class="col-md-12">
              ...
              <div class="pl-lg-4">
                <div class="form-group">
                  <base-input alternative="" label="Conteúdo">
                    <textarea
                    name="conteudo-noticia"
                      rows="4"
                      class="form-control form-control-alternative"
                      placeholder="Escreve aqui o conteúdo da sua notícia"
                    >
Notícia Notícia Notícia Notícia Notícia Notícia Notícia Notícia Notícia Notícia </textarea
                    >
                  </base-input>
                </div>
              </div>
              <button type="submit" class="btn btn-success btn-lg btn-block">Publicar notícia</button>
